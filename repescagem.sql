...
VALUES
('Dr.Dr. João Silva', 'Cardiologia', '123456', '1234-5678', 'joao.silva@hospital.com', 'Rua das Flores, 123', '2020-01-15', '08:00 - 17:00', 'Ativo', 15000.00, '1975-04-12', 'Masculino', 'Especialização em Cardiologia Pediátrica'),
...
SELECT  ('Dr. João Silva', 'Cardiologia', '123456', '1234-5678', 'joao.silva@hospital.com', 'Rua das Flores, 123', '2020-01-15', '08:00 - 17:00', 'Ativo', 15000.00, '1975-04-12', 'Masculino', 'Especialização em Cardiologia Pediátrica'),
('Dra. Maria Oliveira', 'Pediatria', '234567', '2345-6789', 'maria.oliveira@hospital.com', 'Avenida Central, 456', '2019-05-22', '09:00 - 18:00', 'Ativo', 14000.00, '1980-07-19', 'Feminino', 'Especialização em Neonatologia'),
('Dr. Pedro Souza', 'Ortopedia', '345678', '3456-7890', 'pedro.souza@hospital.com', 'Travessa do Sol, 789', '2021-08-30', '10:00 - 19:00', 'Ativo', 14500.00, '1985-12-23', 'Masculino', 'Especialização em Cirurgia Ortopédica'),
('Dr. Carlos Pereira', 'Neurologia', '456789', '4567-8901', 'carlos.pereira@hospital.com', 'Rua dos Pinhais, 101', '2018-11-20', '08:00 - 16:00', 'Ativo', 16000.00, '1970-03-10', 'Masculino', 'Especialização em Neurocirurgia'),
('Dra. Ana Lima', 'Dermatologia', '567890', '5678-9012', 'ana.lima@hospital.com', 'Avenida das Acácias, 202', '2017-09-15', '09:00 - 17:00', 'Ativo', 15500.00, '1982-02-15', 'Feminino', 'Especialização em Dermatoscopia'),
...
SELECT Medicos ;
SET especialidade ="Dr. João Silva cardiologia" ,"Dr. Marcos Silva', 'Cardiologia"

SELECT *FROM Medicos ;
SET nome = "Dr. Felipe Almeida", "Dr. Pedro Souza"
WHERE  data_contratacao = <2020;

SELECT * FROM Medicos; 
SET  data_contratacao =" > or <" ;
WHERE  ('Dr. João Silva', 'Cardiologia', '123456', '1234-5678', 'joao.silva@hospital.com', 'Rua das Flores, 123', '2020-01-15', '08:00 - 17:00', 'Ativo', 15000.00, '1975-04-12', 'Masculino', 'Especialização em Cardiologia Pediátrica'),
('Dra. Maria Oliveira', 'Pediatria', '234567', '2345-6789', 'maria.oliveira@hospital.com', 'Avenida Central, 456', '2019-05-22', '09:00 - 18:00', 'Ativo', 14000.00, '1980-07-19', 'Feminino', 'Especialização em Neonatologia'),
('Dr. Pedro Souza', 'Ortopedia', '345678', '3456-7890', 'pedro.souza@hospital.com', 'Travessa do Sol, 789', '2021-08-30', '10:00 - 19:00', 'Ativo', 14500.00, '1985-12-23', 'Masculino', 'Especialização em Cirurgia Ortopédica'),
('Dr. Carlos Pereira', 'Neurologia', '456789', '4567-8901', 'carlos.pereira@hospital.com', 'Rua dos Pinhais, 101', '2018-11-20', '08:00 - 16:00', 'Ativo', 16000.00, '1970-03-10', 'Masculino', 'Especialização em Neurocirurgia'),
('Dra. Ana Lima', 'Dermatologia', '567890', '5678-9012', 'ana.lima@hospital.com', 'Avenida das Acácias, 202', '2017-09-15', '09:00 - 17:00', 'Ativo', 15500.00, '1982-02-15', 'Feminino', 'Especialização em Dermatoscopia'),
...
SELECT * FROM Medicos;
SET especialidade= "cirugia"
WHERE'Dr. Pedro Souza', 'Ortopedia', '345678', '3456-7890', 'pedro.souza@hospital.com', 'Travessa do Sol, 789', '2021-08-30', '10:00 - 19:00', 'Ativo', 14500.00, '1985-12-23', 'Masculino', 'Especialização em Cirurgia Ortopédica',
'Dra. Helena Martins', 'Oftalmologia', '901234', '9012-3456', 'helena.martins@hospital.com', 'Rua das Palmeiras, 606', '2016-04-10', '07:00 - 15:00', 'Ativo', 16200.00, '1983-04-05', 'Feminino', 'Especialização em Cirurgia Refrativa'
'Dr. Felipe Almeida', 'Ortopedia', '456780', '4567-8901', 'felipe.almeida@hospital.com', 'Rua das Bromélias, 1111', '2021-05-25', '12:00 - 20:00', 'Ativo', 15400.00, '1987-01-15', 'Masculino', 'Especialização em Cirurgia da Coluna';



SELECT * FROM nomes,emails;
SET ordem_alfabetica = 'a or z';
WHERE "todos os medicos";

SELECT * FROM Medicos;
SET telefone = 'termina_com_8905'
WHERE "todos os medicos"


SELECT * FROM Medicos;
SET salario = '15000 ad 16000'
